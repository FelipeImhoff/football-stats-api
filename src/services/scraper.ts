...
async function createTeam(
  ...
  try {
    ...
    const selector: string = `#content > div.scorebox > div:nth-child(${
      isHomeTeam ? 1 : 2
  ...
  const managers: Managers = await page.evaluate(() => {
      ...
      return {
        ...
        away: decodeURI(
          encodeURI(
            document
              .querySelector<HTMLElement>(
                "#content > div.scorebox > div:nth-child(2) > div:nth-child(5)"
              )!
              .innerText.split(": ")[1]
          ).replaceAll("%C2%A0", " ")
        ),
    ...
    if (
      !!document.querySelector<HTMLElement>(
        "#content > div.scorebox > div:nth-child(1) > div:nth-child(4)"
      ) &&
      !!document.querySelector<HTMLElement>(
        "#content > div.scorebox > div:nth-child(2) > div:nth-child(4)"
      )
    ) {
      return {
        home: decodeURI(
...
// Pegando dados errados de jogos sem xG
    ...
    const stats: ScrappedGameData = await page.evaluate(
      (game, managers) => {
        ...
        return {
          ...
          season: game.season,
          competition: document.querySelector("#content > div:nth-child(2) > a")
            .innerHTML,
          homeTeam: document.querySelector(
            "#content > div.scorebox > div:nth-child(1) > div > strong > a"
          ).innerHTML,
          awayTeam: document.querySelector(
            "#content > div.scorebox > div:nth-child(2) > div > strong > a"
          ).innerHTML,
          homeTeamGoals: document
            .querySelector(
              "#content > div.scorebox > div:nth-child(1) > div.scores > div.score"
            )
            .innerHTML.replace(/\D/g, ""),
          awayTeamGoals: document
            .querySelector(
              "#content > div.scorebox > div:nth-child(2) > div.scores > div.score"
            )
            .innerHTML.replace(/\D/g, ""),
          gameStats: selectors
            .map((teamSelector) => {
              return Array.from(
                document.querySelectorAll(
                  `#stats_${teamSelector}_summary > tbody > tr`
                )
              )
                .map((player) => {
                  if (player.querySelector("th > a") !== null) {
                    return {
                      name: player.querySelector("th > a").innerHTML,
                      minutesPlayed: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(6)`
                      ).innerHTML,
                      goals: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(7)`
                      ).innerHTML,
                      assists: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(8)`
                      ).innerHTML,
                      convertedPenalties: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(9)`
                      ).innerHTML,
                      attemptedPenalties: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(10)`
                      ).innerHTML,
                      shots: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(11)`
                      ).innerHTML,
                      shotsOnTarget: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(12)`
                      ).innerHTML,
                      xG: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(19)`
                      ).innerHTML,
                      npxG: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(20)`
                      ).innerHTML,
                      xAG: player.querySelector(
                        `#stats_${teamSelector}_summary > tbody > tr > td:nth-child(21)`
                      ).innerHTML,
                    };
                  }
                })
